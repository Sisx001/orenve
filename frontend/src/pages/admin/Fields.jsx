...
const choices={status:['draft','published','archived'],site_mode:['live','maintenance','coming_soon'],theme:['light','dark'],font:['Manrope','DM Sans'],spacing:['generous','compact'],border_style:['sharp'],floating_position:['right','left'],type:['featured','arrivals','editorial','lookbook','manifesto'],unit:['cm','in']};
