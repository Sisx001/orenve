...
const adminRoutes = ["/admin/login", "/admin", "/admin/orders", "/admin/orders/new", "/admin/products", "/admin/products/new", "/admin/inventory", "/admin/customers", "/admin/coupons", "/admin/shipping", "/admin/catalog", "/admin/homepage", "/admin/pages", "/admin/media", "/admin/reviews", "/admin/messages", "/admin/concierge", "/admin/profile", "/admin/settings/brand", "/admin/settings/features", "/admin/settings/checkout", "/admin/settings/couriers", "/admin/settings/address", "/admin/settings/currency", "/admin/settings/seo", "/admin/settings/site", "/admin/settings/contact", "/admin/settings/ai", "/admin/settings/translations", "/admin/users", "/admin/audit", "/admin/backups"];
